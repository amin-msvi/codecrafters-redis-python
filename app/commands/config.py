...
class ConfigCommand(Command):
    ...
    def execute(self, args: list[str]) -> CommandResult | BlockingResponse | RDBSync | WaitBlocker:  # pyright: ignore[reportReturnType] -> will be fixed in upcoming lessons
        ...
        if operation_type.upper() == "GET":
            ...
            if arguments[0].lower() == "dbfilename":
                return CommandResult(response=["dbfilename", self._server_info.dbfilename])
